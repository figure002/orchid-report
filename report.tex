...
%% APA style
%\bibliographystyle{bst/model5-names}\biboptions{authoryear}

%% AMA style
%\usepackage{numcompress}\bibliographystyle{bst/model6-num-names}

%% `Elsevier LaTeX' style
%\bibliographystyle{elsarticle-num}

%% Custom APA style
%\bibliographystyle{bst/model5-names}
\bibliographystyle{bst/apa-custom}
